...
class Main(tk.Frame):
    ...
    def open_dialog(self):                                                              # Метод open_dialog
        Child()                                                                         # Вызвали класс, отвечающий за добавление данных в базу данных
...
class DB:
    ...
    def data(self):
        ...
        user_data1=('Som', '+79887123655', 'som@gmail.com','120')
        user_data2=('Drew', '+19887776655', 'drew@yandex.com','120')
        user_data3=('Frank', '+79885435454', 'frank@gmail.com','120')
        user_data4=('Greg', '89212341232', 'greg@yandex.com','120')
